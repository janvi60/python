def madlib():
    ...
    madlib = f"I Love  computer programmig because it's {adj1}! The journey to becoming a \
    good programmer starts with the hope in your mind and a dream in your{body_part}. Thourgh blood \
